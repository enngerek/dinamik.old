/*
	...
	this addaction ["Supply Drop", {[[["","C_Offroad_01_F","FncSupplyCargo1"],"supply\supply.sqf"], "BIS_fnc_execVM", true] call BIS_fnc_MP;}];
...
FncSupplyOPF = {_this addAction["<t color='#ff11ff'>Virtual Ammobox</t>", "VAS\open.sqf"];_this addAction["<t color='#ff9900'>HALO jump</t>", "ATM_airdrop\atm_airdrop.sqf"];};
