...
_arac1=["mob_konbasla",resistance,"I_Truck_02_ammo_F"] call ws_fnc_createVehicle;	
sleep 1;
...
sleep 1;
_korumatimi=["mob_konbasla",resistance,"I_Truck_02_covered_F",[],[8,["I_Soldier_lite_F","I_soldier_F","I_Soldier_03_F","I_Soldier_02_F"],true]] call ws_fnc_createVehicle;
sleep 1;
...
_trgkon = createTrigger ["EmptyDetector", getMarkerPos _markerCO]; 
