...
class VAS_Diag {
	...
	onUnload = "VAS_box_weapons = nil; VAS_box_magazines = nil; VAS_box_items = nil; VAS_box_backpacks = nil; VAS_box_goggles = nil; [] spawn {sleep 2; private '_loadout'; _loadout = [player] call INS_REV_FNCT_get_loadout; INS_REV_GVAR_player_loadout = _loadout;}"; //When the dialog is gone set these back to nil.
